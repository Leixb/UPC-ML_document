...
\title{ML course project\\[1.5em] \Large \normalfont NBA and collegiate basketball predictions}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \include{020-data-exploration}
    \include{030-modeling-and-validation}
    \include{040-final-model}
    \include{050-conclusions}
